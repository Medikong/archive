...
| ADR-0010 | proposed | 2026-07-02 | DropMong을 5개 서비스로 시작한다 | `0010-five-service-boundary.md` |
| ADR-0011 | proposed | 2026-07-02 | order-service가 재고 예약을 소유한다 | `0011-order-service-owns-inventory.md` |
| ADR-0012 | proposed | 2026-07-02 | DropMong은 Kong 대신 Istio Ingress Gateway를 사용한다 | `0012-istio-ingress-not-kong.md` |
| ADR-0013 | proposed | 2026-07-02 | 주문과 결제 이벤트에 transactional outbox를 사용한다 | `0013-transactional-outbox.md` |
