...
| 제외 | 해외 | Nike SNKRS | 드롭 방식(FLOW/LEO/DAN) 및 응모 심사 해설 | - | 2026-07-09 | en | 드롭 방식, 관심 신호 기반 심사 | - | 서드파티 해설 글 위주라 내부 알고리즘 근거 없음. DropMong 요구사항/분석에 실제로 인용되지 않아 제외 |
| 제외 | 해외 | Mercari | Zero Downtime Migration with Strong Data Consistency Part II | - | 2026-07-09 | en | 무중단 마이그레이션, 데이터 정합성 | - | 원문 미열람 상태로 활용 안 됨 |
| 제외 | 해외 | Pinterest | Building a dynamic and responsive Pinterest | - | 2026-07-09 | en | Interest Feed, Pixie 추천 시스템 | - | 원문 확인했으나 인프라 진화사 위주라 찜/랭킹 설계에 참고할 구체적 내용 없음 |
| 제외 | 해외 | algomaster.io | Designing a Scalable Likes Counting System | - | 2026-07-09 | en | 좋아요 카운팅 진화, 핫키 쓰기 경합 | - | 유료 콘텐츠로 핵심부 막힘. Facebook 사례로 대체됨 |
| 제외 | 해외 | KISO / Twitter(X) | 실시간 급상승 검증보고서 / rolling window 카운터 | - | 2026-07-09 | ko/en | 알고리즘 신뢰성 검증, 다중 시간 윈도우 카운터 | - | PDF 추출 실패·403으로 미확인. 오픈 전 랭킹을 급상승 대신 당일 리셋 방식으로 결정하며 주제 자체가 불필요해짐 |
| 분석 | 개인 블로그 | sweet_sumin (velog) | 좋아요 멱등성: 올리브영, 무신사, 컬리는 어떻게 다르게 구현했을까? | https://beta.velog.io/@sweet_sumin/%EC%A2%8B%EC%95%84%EC%9A%94-%EB%A9%B1%EB%93%B1%EC%84%B1-%EC%98%AC%EB%A6%AC%EB%B8%8C%EC%98%81-%EB%AC%B4%EC%8B%A0%EC%82%AC-%EC%BB%AC%EB%A6%AC%EB%8A%94-%EC%96%B4%EB%96%BB%EA%B2%8C-%EB%8B%A4%EB%A5%B4%EA%B2%8C-%EA%B5%AC%ED%98%84%ED%96%88%EC%9D%84%EA%B9%8C | 2026-07-09 | ko | 찜 API 설계, 멱등성, HTTP 메서드 비교 | analysis/04-wishlist-api-design.md | 세 회사 실제 요청을 관찰해 비교한 개인 블로그, 공식 자료 아님 |
| 분석 | 해외(공식) | Redis | Build a Real-Time Leaderboard with Redis Sorted Sets | https://redis.io/tutorials/howtos/leaderboard/ | 2026-07-09 | en | Sorted Set, ZADD/ZINCRBY/ZREVRANGE, 리더보드 서빙 | companies/global/redis/posts/undated-redis-official-leaderboard-tutorial.md | Redis 공식 튜토리얼 |
| 분석 | 해외(공식) | Alibaba Cloud | High-Concurrency Practices of Redis: Snap-Up System | https://www.alibabacloud.com/blog/high-concurrency-practices-of-redis-snap-up-system_597858 | 2026-07-09 | en | 플래시 세일, 계층형 필터링, Lua 원자적 재고 차감, 분산 락 | companies/global/alibaba-cloud/posts/undated-alibaba-cloud-snapup-concurrency.md | Alibaba Cloud Community 공식 블로그 |
| 분석 | 국내(공식) | Toss | 서버 증설 없이 처리하는 대규모 트래픽 | https://toss.tech/article/27600 | 2026-07-09 | ko | 캐싱 전략(Universal/User-Specific), 카운터 로컬 집계 후 flush | companies/domestic/toss/posts/undated-toss-traffic-caching-strategy.md | Toss Tech 공식 블로그 |
| 분석 | 국내(공식) | 쿠팡 | 대용량 트래픽 처리를 위한 쿠팡의 백엔드 전략 | https://medium.com/coupang-engineering/%EB%8C%80%EC%9A%A9%EB%9F%89-%ED%8A%B8%EB%9E%98%ED%94%BD-%EC%B2%98%EB%A6%AC%EB%A5%BC-%EC%9C%84%ED%95%9C-%EC%BF%A0%ED%8C%A1%EC%9D%98-%EB%B0%B1%EC%97%94%EB%93%9C-%EC%A0%84%EB%9E%B5-184f7fdb1367 | 2026-07-09 | ko | 마이크로서비스 데이터 통합 서빙, 다층 캐시 | companies/domestic/coupang/posts/undated-coupang-backend-traffic-strategy.md | Coupang Engineering Blog (Medium) |
| 분석 | 해외 | Facebook (Meta) | 5 Billion Likes a Day: The System Design Behind Facebook's Like Button | https://medium.com/@V9vek/5-billion-likes-a-day-the-system-design-behind-facebooks-like-button-501e4bf1044d | 2026-07-09 | en | postId 샤딩, CDC(Debezium)+Kafka 비동기 집계, 핫 포스트 격리 | companies/global/facebook/posts/undated-facebook-like-button-sharded-counter.md | 제3자 시스템 설계 해설 글, Facebook 공식 발표 아님 |
