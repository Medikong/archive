...
🏷️ BC 참조: [BC.A.01](../../../../40-event-storming-bounded-context/.examples/BC_A_01_order.md) | 도메인 참조: [AGG.A.01](../A_01_10-domain-model/AGG_A_01_order.md) | 서비스 참조: [SVC.A.01](../A_01_30-service/SVC_A_01_order_service.md) | API 참조: [API.A.01](../A_01_40-api/API_A_01_place_order.md) | 시나리오 참조: [SCN.A.01](../../../../80-sequence/.examples/SCN_A_01_place_order.md)
