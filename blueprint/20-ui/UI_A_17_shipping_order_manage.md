...
- UI ID: `UI.A.17`
- 연관 Page: [PAGE.A.17](../10-sitemap/PAGE_A_17_shipping_order_manage.md)
...
- 원본 URL: local
- 캡처 일시: 2026-07-07
- 캡처 조건: DropMong 배송/주문 관리, 배송중 주문, 활성/비활성 메뉴, 추가 관리, 상태 안내 배너, CTA 버튼 상태

## 연관 태그

🏷️ 요구사항 참조: [REQ.A.01](../00-requirements/REQ_A_01_limited_drop_commerce.md), [REQ.A.02](../00-requirements/REQ_A_02_coupon_benefit.md) | 페이지 참조: [PAGE.A.17](../10-sitemap/PAGE_A_17_shipping_order_manage.md) | UC 참조: UC.A.17 | 영속성 참조: PST.A.17 | 서비스 참조: SVC.A.17 | 시나리오 참조: SCN.A.17 | API 참조: API.A.17
