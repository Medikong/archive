...
- UI ID: `UI.A.10`
- 연관 Page: [PAGE.A.10](../10-sitemap/PAGE_A_10_my.md)
...
- 원본 URL: local
- 캡처 일시: 2026-07-07
- 캡처 조건: DropMong 마이, 프로필, 요약 지표, 최근 주문, 전체 메뉴, 친구 초대 배너, 하단 탭 상태

## 연관 태그

🏷️ 요구사항 참조: [REQ.A.01](../00-requirements/REQ_A_01_limited_drop_commerce.md), [REQ.A.02](../00-requirements/REQ_A_02_coupon_benefit.md) | 페이지 참조: [PAGE.A.10](../10-sitemap/PAGE_A_10_my.md) | UC 참조: UC.A.10 | 영속성 참조: PST.A.10 | 서비스 참조: SVC.A.10 | 시나리오 참조: SCN.A.10 | API 참조: API.A.10
