...
- UI ID: `UI.A.11`
- 연관 Page: [PAGE.A.11](../10-sitemap/PAGE_A_11_payment.md)
...
- 원본 URL: local
- 캡처 일시: 2026-07-07
- 캡처 조건: DropMong 주문/결제, 배송지 확인, 상품 목록, 결제 수단, 쿠폰, 포인트, 동의, 최종 결제 금액 상태

## 연관 태그

🏷️ 요구사항 참조: [REQ.A.01](../00-requirements/REQ_A_01_limited_drop_commerce.md), [REQ.A.02](../00-requirements/REQ_A_02_coupon_benefit.md) | 페이지 참조: [PAGE.A.11](../10-sitemap/PAGE_A_11_payment.md) | UC 참조: UC.A.11 | 영속성 참조: PST.A.11 | 서비스 참조: SVC.A.11 | 시나리오 참조: SCN.A.11 | API 참조: API.A.11
