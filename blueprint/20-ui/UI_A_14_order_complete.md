...
- UI ID: `UI.A.14`
- 연관 Page: [PAGE.A.14](../10-sitemap/PAGE_A_14_order_complete.md)
...
- 원본 URL: local
- 캡처 일시: 2026-07-07
- 캡처 조건: DropMong 주문 완료, 성공 상태, 주문 요약, 배송 일정, 구매 상품, 포인트 적립 예정 상태

## 연관 태그

🏷️ 요구사항 참조: [REQ.A.01](../00-requirements/REQ_A_01_limited_drop_commerce.md), [REQ.A.02](../00-requirements/REQ_A_02_coupon_benefit.md) | 페이지 참조: [PAGE.A.14](../10-sitemap/PAGE_A_14_order_complete.md) | UC 참조: UC.A.14 | 영속성 참조: PST.A.14 | 서비스 참조: SVC.A.14 | 시나리오 참조: SCN.A.14 | API 참조: API.A.14
