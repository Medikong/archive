...
- 기준 기능: 상품 탐색, 상품 확인, 드롭 알림, 관심 상품, 장바구니, 주문/결제, 쿠폰/포인트 적용, 배송지 선택, 주문 완료, 주문 내역, 배송 조회, 배송/주문 관리
...
flowchart LR
    ...
    subgraph CommerceSystem["DropMong 구매 및 배송 시스템"]
        ...
        UC0107(("UC.A.01-07<br/>쿠폰/포인트 적용"))
...
| `UC.A.01-07` | 구매자 | 쿠폰/포인트 적용 | 주문에 사용할 수 있는 쿠폰과 포인트를 선택한다. | `REQ.A.02.FR-009` |
