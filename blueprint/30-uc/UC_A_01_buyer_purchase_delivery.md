...
- 🏷️ 플로우 참조: FLOW.A.01
- 🏷️ 요구사항 참조: [REQ.A.01](../00-requirements/REQ_A_01_limited_drop_commerce.md), [REQ.A.02](../00-requirements/REQ_A_02_coupon_benefit.md), [REQ.A.07](../00-requirements/REQ_A_07_interest_ranking.md)(`UC.A.01-04` 관심 상품 위임)
...
| `UC.A.01-04` | 구매자 | 관심 상품(2026-07-14 정정, 위임: `UC.A.07-01`) | 구매 후보 상품을 관심 목록에 저장한다. 실제 소유는 `BC.A.07`/interest-service이며, 이 표는 진입 지점만 남긴다. | `REQ.A.07.FR-001`, `REQ.A.07.FR-002`(기존에 잘못 매핑됐던 `REQ.A.01.FR-004`는 드롭 카운트다운 요구사항이라 관심 상품과 무관함, 정정) |
