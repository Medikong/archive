...
![마이 페이지](../20-ui/assets/UI_A_10_my/UI_A_10_01_my.png)
...
🏷️ 요구사항 참조: [REQ.A.01](../00-requirements/REQ_A_01_limited_drop_commerce.md), [REQ.A.02](../00-requirements/REQ_A_02_coupon_benefit.md) | 플로우 참조: FLOW.A.10 | UI 참조: [UI.A.10](../20-ui/UI_A_10_my.md) | UC 참조: UC.A.10 | 영속성 참조: PST.A.10 | 서비스 참조: SVC.A.10 | 시나리오 참조: SCN.A.10 | API 참조: API.A.10
