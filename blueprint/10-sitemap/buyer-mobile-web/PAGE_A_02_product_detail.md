...
🏷️ 요구사항 참조: [REQ.A.01](../../00-requirements/REQ_A_01_limited_drop_commerce.md) | 플로우 참조: FLOW.A.01 | UI 참조: [UI.A.02](../../20-ui/buyer-mobile-web/UI_A_02_product_detail.md) | UC 참조: UC.A.02 | 영속성 참조: PST.A.02 | 서비스 참조: SVC.A.02 | 시나리오 참조: SCN.A.02 | API 참조: API.A.02
