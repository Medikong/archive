...
![주문/결제 페이지](../20-ui/assets/UI_A_11_payment/UI_A_11_01_payment.png)
...
🏷️ 요구사항 참조: [REQ.A.01](../00-requirements/REQ_A_01_limited_drop_commerce.md), [REQ.A.02](../00-requirements/REQ_A_02_coupon_benefit.md) | 플로우 참조: FLOW.A.11 | UI 참조: [UI.A.11](../20-ui/UI_A_11_payment.md) | UC 참조: UC.A.11 | 영속성 참조: PST.A.11 | 서비스 참조: SVC.A.11 | 시나리오 참조: SCN.A.11 | API 참조: API.A.11
