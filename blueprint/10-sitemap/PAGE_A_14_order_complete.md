...
![주문 완료 페이지](../20-ui/assets/UI_A_14_order_complete/UI_A_14_01_order_complete.png)
...
🏷️ 요구사항 참조: [REQ.A.01](../00-requirements/REQ_A_01_limited_drop_commerce.md), [REQ.A.02](../00-requirements/REQ_A_02_coupon_benefit.md) | 플로우 참조: FLOW.A.14 | UI 참조: [UI.A.14](../20-ui/UI_A_14_order_complete.md) | UC 참조: UC.A.14 | 영속성 참조: PST.A.14 | 서비스 참조: SVC.A.14 | 시나리오 참조: SCN.A.14 | API 참조: API.A.14
