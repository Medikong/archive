...
> 문서 상태: 초기 검토 기록. 공통 언어와 통신 경계의 최신 제안은 `../_shared/adr/ADR-001-service-language.md`와 `../_shared/adr/ADR-002-rest-grpc-kafka-boundary.md`를 기준으로 하며, ADR이 채택되기 전에는 확정 결정으로 해석하지 않는다.
