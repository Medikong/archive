...
검증 후 cleanup exit 0과 잔존 container 0 / volume 0을 확인했다. Log correlation과 Kafka lag 확인은 아직 별도 자동화 대상이다.
...
다음 단계는 log correlation, Kafka lag, notification 업무 metric까지 자동 판정하는 것이다.
